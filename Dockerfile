...
RUN apt-get update && apt-get -y install apt-transport-https ca-certificates gnupg software-properties-common wget
...
# STM32L1 Sources
RUN mkdir -p /opt/stm32cubeL1
RUN cd /opt/stm32cubeL1 \
