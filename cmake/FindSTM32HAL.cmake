...
if(STM32HAL_FOUND AND NOT TARGET STM32Cube::HAL)
    add_library(STM32Cube::HAL INTERFACE IMPORTED)
    set_target_properties(STM32Cube::HAL 
        PROPERTIES
        INTERFACE_LINK_LIBRARIES STM32Cube::CMSIS
        INTERFACE_INCLUDE_DIRECTORIES "${STM32HAL_INCLUDE_DIRS}"
        INTERFACE_SOURCES "${STM32HAL_SOURCES}"
        )
endif()
