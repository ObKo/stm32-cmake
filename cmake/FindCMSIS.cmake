...
IF(STM32_CHIP_TYPE)
    ...
    SET(CMSIS_COMPILE_DEFINITIONS "STM32F${STM32_CHIP_TYPE}")
ENDIF()
...
IF(CMSIS_FOUND AND NOT TARGET STM32Cube::CMSIS)
    ADD_LIBRARY(STM32Cube::CMSIS INTERFACE IMPORTED)
    SET_TARGET_PROPERTIES(STM32Cube::CMSIS 
        PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES "${CMSIS_INCLUDE_DIRS}"
        INTERFACE_SOURCES "${CMSIS_SOURCES}"
        INTERFACE_COMPILE_DEFINITIONS "${CMSIS_COMPILE_DEFINITIONS}"
        )
ENDIF()
