...
foreach(COMP ${CMSIS_FIND_COMPONENTS_FAMILIES})
    ...
    if(STM32_CMSIS_${FAMILY}_PATH AND NOT IS_ABSOLUTE "${STM32_CMSIS_${FAMILY}_PATH}")
        get_filename_component(STM32_CMSIS_${FAMILY}_PATH "${STM32_CMSIS_${FAMILY}_PATH}" ABSOLUTE)
        set(STM32_CMSIS_${FAMILY}_PATH ${STM32_CMSIS_${FAMILY}_PATH} CACHE PATH "Path to STM32 CMSIS ${FAMILY}" FORCE)
    endif()
    if(STM32_CMSIS_PATH AND NOT IS_ABSOLUTE "${STM32_CMSIS_PATH}")
        get_filename_component(STM32_CMSIS_PATH "${STM32_CMSIS_PATH}" ABSOLUTE)
